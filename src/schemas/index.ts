...
import { OrderType, type Sizes } from "../types";
...
export const uint = (
  n: Sizes = 256
): ZodEffects<ZodEffects<ZodString, bigint, string>, bigint, string> => {
...
export const orderSchema = z.object({
  ...
  price: uint(256),
  type: z.enum(
    Object.values(OrderType).map((x) => x.toString()) as [string, ...string[]]
  ),
